...
object DataStore {
    ...
    val tasks = mutableListOf(
        Task(taskId = 1,name = "Task 1", projectId = 1),
        Task(taskId = 2,name = "Task 2", projectId = 1),
        Task(taskId = 3,name = "Task 3", projectId = 2),
        Task(taskId = 4,name = "Task 4", projectId = 3),
        Task(taskId = 5,name = "Task 5", projectId = 3),
        Task(taskId = 6,name = "Task 6", projectId = 3),
        Task(taskId = 7,name = "Task 7", projectId = 3),
        Task(taskId = 8,name = "Task 8", projectId = 3),
        Task(taskId = 9,name = "Task 9", projectId = 4),
        Task(taskId = 10,name = "Task 10", projectId = 4),
        Task(taskId = 11,name = "Task 11", projectId = 4),
        Task(taskId = 12,name = "Task 12", projectId = 5),
        Task(taskId = 13,name = "Task 13", projectId = 5),
        Task(taskId = 14,name = "Task 14", projectId = 5),
        Task(taskId = 15,name = "Task 15", projectId = 6),
        Task(taskId = 16,name = "Task 16", projectId = 6)
    )
